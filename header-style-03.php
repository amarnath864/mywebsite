...
?>
            ...
            <div id="rev_slider_5_3" class="rev_slider fullwidthabanner" data-version="5.4.8">
                <ul>
                    <li data-index="rs-6" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="1500" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="images/slides/slider-mainbg-005.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>

                        <!-- LAYERS -->

                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-6-layer-1" data-x="['left','left','left','left']" data-hoffset="['50','40','30','30']" 
                            data-y="['top','top','top','top']" data-voffset="['176','120','80','65']"
                            ...
                            data-type="text"
                            data-responsive_offset="on">Designing For
                        </div>

                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption tp-resizeme" id="slide-6-layer-2" data-x="['left','left','left','left']" 
                            data-hoffset="['50','40','30','30']" data-y="['top','top','top','middle']" data-voffset="['233','190','140','-30']"
                            ...
                            data-paddingleft="[0,0,0,0]"
                            data-type="text"
                            data-responsive_offset="on">Innovative Tools
                        </div>

                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-resizeme" id="slide-6-layer-3" data-x="['left','left','left','left']" data-hoffset="['50','40','30','30']" 
                            data-y="['top','top','top','middle']" data-voffset="['320','285','225','25']" 
                            ...
                            data-paddingleft="[0,0,0,0]"
                            data-type="text"
                            data-responsive_offset="on">Start Tools At <strong class="ttm-textcolor-highlight">$99</strong> Only
                        </div>


                        <!-- LAYER NR. 4 -->
                        <a class="tp-caption rev-button ttm-bgcolor-highlight" href="#" target="_self" id="slide-6-layer-4" data-x="['left','left','left','left']" data-hoffset="['50','40','30','30']" data-y="['bottom','bottom','bottom','middle']" data-voffset="['184','120','80','96']" 
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-7" data-transition="fade" data-slotamount="1"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="images/slides/slider-mainbg-006.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-description="">
                        ...
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-resizeme" id="slide-7-layer-1" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" 
                            data-y="['top','top','top','top']" data-voffset="['176','120','80','65']"
                        ...
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption tp-resizeme" id="slide-7-layer-2" data-x="['left','left','left','center']" 
                            data-hoffset="['50','40','30','0']" data-y="['top','top','top','middle']" data-voffset="['233','190','140','-30']"
                        ...
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-resizeme" id="slide-7-layer-3" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" 
                            data-y="['top','top','top','middle']" data-voffset="['320','285','225','25']"
                            ...
                            data-paddingleft="[0,0,0,0]"
                            data-type="text"
                            data-responsive_offset="on">Start Tools At <strong class="ttm-textcolor-highlight">$59</strong> Only
                        </div>


                        <!-- LAYER NR. 4 -->
                        <a class="tp-caption rev-button ttm-bgcolor-highlight" href="#" target="_self" id="slide-7-layer-4" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['bottom','bottom','bottom','middle']" data-voffset="['184','120','80','96']" 
    ...
    <div class="site-main">
        ...
        <!-- banner-top-section -->
        <section class="banner-top-section clearfix">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <!-- banner-image -->
                        <div class="banner-image pt-30">
                            <a href="#"><img class="img-fluid" src="images/banner-six.jpg" alt=""></a>
                        </div><!-- banner-image end -->
                    </div>
                    <div class="col-sm-6">
                        <!-- banner-image -->
                        <div class="banner-image pt-30">
                            <a href="#"><img class="img-fluid" src="images/banner-seven.jpg" alt=""></a>
                        </div><!-- banner-image end -->
                    </div>
                    <div class="col-lg-6">
                        <div class="pt-30">
                            <div class="blink-block ttm-bgcolor-skincolor pt-30 pb-10 ttm-textcolor-white text-center">
                                <h4>SHOPPING THE SALE NOW!</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- banner-image -->
                        <div class="banner-image pt-30">
                            <a href="#"><img class="img-fluid" src="images/banner-eleven.jpg" alt=""></a>
                        </div><!-- banner-image end -->
                    </div>
                </div><!-- row end -->
            </div>
        ...
        <section class="product-banner-section clearfix">
            <div class="container"> 
                <div class="row">
                    <div class="col-lg-12">
                        <div class="products">
                            <div class="row no-gutters">
                                <div class="col-lg-12 ttm-bgcolor-white box-shadow">
                                    <div class="row">
                                        <div class="col-lg">
                                            <!-- banner-image -->
                                            <div class="banner-image">
                                                <a href="#"><img class="img-fluid" src="images/banner-twell.jpg" alt=""></a>
                                            </div><!-- banner-image end -->
                                        </div>
                                        <!-- product -->
                                        <div class="col-lg col-md-3 col-sm-4 product">
                                            <div class="product-box">
                                                <!-- product-box-inner -->
                                                <div class="product-box-inner">
                                                    <div class="product-image-box">
                                            ...
                                            <div class="product-box">
                                                ...
                                                <div class="product-box-inner">
                                                    ...
                                                    <div class="product-btn-links-wrapper">
                                                        <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart" tabindex="0"><i class="ti ti-shopping-cart"></i></a>
                                                        </div>
                                                        <div class="product-btn"><a href="#" class="quick-view-btn js-show-modal1 tooltip-top" data-tooltip="Quick View" tabindex="0"><i class="ti ti-search"></i></a>
                                                        </div>
                                                        <div class="product-btn"><a href="#" class="wishlist-btn tooltip-top" data-tooltip="Add To Wishlist" tabindex="0"><i class="ti ti-heart"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!-- product-box-inner end -->
                                                <div class="product-content-box">
                                                    <a class="product-title" href="product-layout1.php" tabindex="0">
                                                        <h2>Rotary Hammer</h2>
                                                    </a>
                                                    <div class="star-ratings">
                                                        <ul class="rating">
                                        ...
                                        <div class="col-lg col-md-3 col-sm-12">
                                            <div class="coupen-box">
                                                <h4>Best Sellings</h4>
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting indard dummy text ever since the 1500s,</p>
                                                <div class="coupen_code ttm-textcolor-skincolor"><span class="name">Code:</span><span class="code"> NW7845</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <!-- banner-image -->
                        <div class="banner-image pt-30">
                            <a href="#"><img class="img-fluid" src="images/banner-fourteen.jpg" alt=""></a>
                        </div><!-- banner-image end -->
                    </div>
                    <div class="col-sm-6">
                        <!-- banner-image -->
                        <div class="banner-image pt-30">
                            <a href="#"><img class="img-fluid" src="images/banner-fifteen.jpg" alt=""></a>
                        </div><!-- banner-image end -->
                    </div>
                </div><!-- row end -->
                <div class="pt-30 row">
                                        ...
                                        <div class="col-lg">
                                            ...
                                            <div class="banner-image">
                                                <figure class="ttm-figure">
                                                    <a href="#"><img class="img-fluid" src="images/banner-thirteen.jpg" alt=""></a>
                                                </figure>
                                            </div><!-- banner-image end -->
                                        </div>
                                        <!-- product -->
        ...
        </section><!-- product-banner-section end-->
...
<!-- Mirrored from themetechmount.com/html/fixfellow/header-style-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jan 2023 05:09:46 GMT -->
</html>